...
--플레이데스크삽입
update playDesk set player_ID='admin',player_Name='사용자',game_Name='체스',playTime=105 where desk_idx=1;
...
insert into foodMenu (food_idx, food_Name, food_Count, food_Price, food_Type) values (1, '아메리카노', 100, 2500, '음료');
insert into foodMenu (food_idx, food_Name, food_Count, food_Price, food_Type) values (2, '자몽에이드', 100, 4000, '음료');
insert into foodMenu (food_idx, food_Name, food_Count, food_Price, food_Type) values (3, '캔콜라', 100, 2000, '음료');
insert into foodMenu (food_idx, food_Name, food_Count, food_Price, food_Type) values (4, '피자(1조각)', 100, 4000, '음식');
insert into foodMenu (food_idx, food_Name, food_Count, food_Price, food_Type) values (5, '치킨(반마리)', 100, 10000, '음식');
...
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (1, '코코너츠', 2, 5, 1, '설명', 4);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (2, '루핑루이', 2, 5, 1, '설명', 3);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (3, '흔들흔들해적선', 2, 5, 1, '설명', 4);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (4, '꼬치의 달인', 2, 5, 1, '설명', 6);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (5, '마블봅슬레이', 2, 5, 1, '설명', 3);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (6, '스플렌터', 2, 5, 1, '설명', 2);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (7, '로젠코닉', 2, 5, 1, '설명', 2);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (8, '아줄', 2, 5, 1, '설명', 2);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (9, '패치워크', 2, 5, 1, '설명', 2);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (10, '로스트시티', 2, 5, 1, '설명', 2);
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (11, '햄버거타이쿤', 2, 5, 1, '설명', '2~4');
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (12, '루미큐브', 2, 5, 1, '설명', '2~4');
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (13, '다빈치코드', 2, 5, 1, '설명', '2~4');
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (14, '돌팔이약장수', 2, 5, 1, '설명', '2~4');
INSERT INTO gameMenu(game_idx, game_Name, game_Count, game_TotalCount, game_Price, game_info, game_PlayerNum)
VALUES (15, '돌팔이약장수', 2, 5, 1, '설명', '2~4');
